...
module "ncc_hub_spoke" {
  ...
  ncc_to_spoke_a_ip_range_0 = var.ncc_to_spoke_a_ip_range_0
  spoke_a_to_ncc_ip_range_0 = var.spoke_a_to_ncc_ip_range_0
  spoke_a_to_ncc_peer_ip_0  = var.spoke_a_to_ncc_peer_ip_0
  ncc_to_spoke_a_peer_ip_0  = var.ncc_to_spoke_a_peer_ip_0
  ncc_to_spoke_a_ip_range_1 = var.ncc_to_spoke_a_ip_range_1
  spoke_a_to_ncc_ip_range_1 = var.spoke_a_to_ncc_ip_range_1
  spoke_a_to_ncc_peer_ip_1  = var.spoke_a_to_ncc_peer_ip_1
  ncc_to_spoke_a_peer_ip_1  = var.ncc_to_spoke_a_peer_ip_1
